    ...
    <main className="space-y-6">
      ...
      <section className="rounded-xl bg-panel/95 p-4 shadow-panel md:p-5">
        <div className="mb-5 flex flex-col gap-3 xl:flex-row">
          <div className="h-11 flex-1 animate-pulse rounded-lg bg-white/10" />
          <div className="grid gap-3 sm:grid-cols-3">
            <div className="h-11 w-full animate-pulse rounded-lg bg-white/10 sm:w-40" />
            <div className="h-11 w-full animate-pulse rounded-lg bg-white/10 sm:w-40" />
            <div className="h-11 w-full animate-pulse rounded-lg bg-white/10 sm:w-32" />
          </div>
        </div>
