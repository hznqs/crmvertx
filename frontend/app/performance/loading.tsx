  ...
  return (
    <main className="space-y-6">
      ...
      <section className="rounded-xl bg-panel/95 p-4 shadow-panel md:p-5">
        <div className="mb-5 grid gap-3 lg:grid-cols-[1fr_1fr_1fr_140px]">
          {Array.from({ length: 4 }).map((_, index) => <div key={index} className="h-11 animate-pulse rounded-lg bg-white/10" />)}
        </div>
