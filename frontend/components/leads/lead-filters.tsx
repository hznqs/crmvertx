...
export function LeadFilters({ query }: LeadFiltersProps) {
    ...
    <div className="mb-5 space-y-3">
      <div className="flex flex-col gap-3 xl:flex-row">
        ...
        <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
          <PremiumSelect
            value={query.commercialStage}
            onChange={(value) => updateFilter("commercialStage", value)}
            placeholder="Todas as fases"
            options={[{ value: "", label: "Todas as fases" }, ...toOptions(commercialStageLabels)]}
          />
          ...
          <PremiumSelect
            ...
            options={[{ value: "", label: "Temperatura" }, ...toOptions(leadTemperatureLabels)]}
          />
          ...
          <PremiumSelect
            ...
            placeholder="Origem"
            options={[{ value: "", label: "Origem" }, ...toOptions(leadOriginLabels)]}
          />
          ...
          <PremiumSelect
            ...
            placeholder="Status"
            options={[{ value: "", label: "Status" }, ...toOptions(leadStatusLabels)]}
          />
        </div>
      </div>
